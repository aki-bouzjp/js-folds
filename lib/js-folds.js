...
export default new class JsFolds {
  ...
  checkDupeFolds(folds, range) {
    console.log("start row:" + range.start.row + " column:" + range.start.column + " end row:" + range.end.row + " column:" + range.end.column);
    return folds.some((fold) => {
      ...
      if (fold.start.row === range.start.row &&
        ...
        console.log("start row:" + fold.start.row + " column:" + fold.start.column + " end row:" + fold.end.row + " column:" + fold.end.column);
        return true;
      }
    });
  }
